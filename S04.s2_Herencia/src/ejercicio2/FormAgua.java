...
public class FormAgua extends javax.swing.JFrame {
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        Agua a = new Agua(2.50, 0.75);
        a.setConsumo(Double.parseDouble(txtConsumo.getText()));
        a.calcularMontoPagar();
        txtSalida.append("Cargo fijo "+a.getCargoFijo()+"\n");
        txtSalida.append("Consumo "+a.getConsumo()+"\n");
        txtSalida.append("Tarifa "+a.getTarifa()+"\n");
        txtSalida.append("Monto a pagar "+a.getMontoPagar()+"\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAgua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
